...
use PhenyxInvoicing\Exceptions\ValidationException;
    ...
    private function getDefaultRules(): array{
        ...
        $res['BR-01'] = static function (Invoice $inv) {
            ...
            if ($inv->getSpecification() === null) {
                return "An Invoice shall have a Specification identifier (BT-24)";
            }
        ...
        $res['BR-02'] = static function (Invoice $inv) {
            ...
            if ($inv->getNumber() === null) {
                return "An Invoice shall have an Invoice number (BT-1)";
            }
        ...
        $res['BR-03'] = static function (Invoice $inv) {
            ...
            if ($inv->getIssueDate() === null) {
                return "An Invoice shall have an Invoice issue date (BT-2)";
            }
        ...
        $res['BR-06'] = static function (Invoice $inv) {
            ...
            if ($inv->getSeller() === null) {
                return "Missing Seller from Invoice";
            }

            if ($inv->getSeller()->getName() === null) {
                return "An Invoice shall contain the Seller name (BT-27)";
            }
        ...
        $res['BR-07'] = static function (Invoice $inv) {
            ...
            if ($inv->getBuyer() === null) {
                return "Missing Buyer from Invoice";
            }

            if ($inv->getBuyer()->getName() === null) {
                return "An Invoice shall contain the Buyer name (BT-44)";
            }
        ...
        $res['BR-16'] = static function (Invoice $inv) {
            ...
            if (empty($inv->getLines())) {
                return "An Invoice shall have at least one Invoice line (BG-25)";
            }

        };
        $res['BR-17'] = static function (Invoice $inv) {

            if ($inv->getPayee() === null) {
                return;
            }

            if ($inv->getSeller()->getName() === $inv->getPayee()->getName()) {
                return;
            }
        ...
        $res['BR-25'] = static function (Invoice $inv) {
            ...
            foreach ($inv->getLines() as $line) {
                ...
                if ($line->getName() === null) {
                    return "Each Invoice line (BG-25) shall contain the Item name (BT-153)";
                }
        ...
        $res['BR-27'] = static function (Invoice $inv) {
            ...
            foreach ($inv->getLines() as $line) {
                ...
                if ($line->getPrice() < 0) {
                    return "The Item net price (BT-146) shall NOT be negative";
                }
        ...
        $res['BR-51'] = static function (Invoice $inv) {
            ...
            if ($inv->getPayment()->getCard() === null) {
                return;
            }
        ...
        $res['BR-61'] = static function (Invoice $inv) {
            ...
            if (!in_array($inv->getPayment()->getMeansCode(), ['30', '58'])) {
                return;
            }
